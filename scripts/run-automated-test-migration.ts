/**
 * Run the automated-test tables migration using the app's MySQL connection.
 * Usage: npx tsx scripts/run-automated-test-migration.ts
 */
...
const MIGRATION_PATH = join(__dirname, "..", "migrations", "manual", "add-automated-test-tables.sql");

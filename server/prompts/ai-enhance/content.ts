...
export const AI_ENHANCE_CONTENT_PROMPT = `${AI_ENHANCE_ROLE_PREAMBLE}

${AI_ENHANCE_GENERAL_RULES}

GENERAL CONTENT HANDLING:
When the content is general content and an extra prompt specifies a change:
...
When the content is general content and there is no extra prompt:

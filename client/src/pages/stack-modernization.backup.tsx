/**
 * Stack Modernization - Compact Single-Page Design
...
type WorkflowStage = "upload" | "analyze" | "prompt" | "upgrade" | "review";
...
export default function StackModernizationPage() {
  ...
  const handleUploadAndAnalyze = async () => {
    ...
    try {
      ...
      while (attempts < maxAttempts) {
        ...
        setProgress(50 + (progressData.progress * 0.4)); // 50-90%
        ...
        if (progressData.currentStage === "awaiting_user_selection" || progressData.currentStage === "completed") {
          ...
          if (resultsRes.ok) {
            ...
            toast({
              ...
              description: "Tech stack detected. Define your upgrade requirements.",
            });
          }
        ...
        return (
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>
                Upload a ZIP file containing your .NET project
              </CardDescription>
            </CardHeader>
              ...
              <div className="border-2 border-dashed rounded-lg p-8 text-center hover:bg-accent/50 transition-colors">
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    ZIP, .csproj, or .NET source files
                  </p>
                </label>
              </div>
        ...
        return (
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>
                AI agents are analyzing your code, dependencies, and frameworks
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
  ...
  const stages = [
    ...
    { id: "review", label: "Review", icon: GitBranch }
  ];
  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Stack Modernization</h1>
          <p className="text-muted-foreground mt-1">
            AI-powered .NET code upgrade
          </p>
        </div>
        {stage !== "upload" && (
          <Button 
        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            {stages.map((s, idx) => {
              ...
              const isActive = stage === s.id || (stage === "analyze" && s.id === "upload");
              const isCompleted = 
                (s.id === "upload" && ["prompt", "upgrade", "review"].includes(stage)) ||
                (s.id === "prompt" && ["upgrade", "review"].includes(stage)) ||
                (s.id === "upgrade" && stage === "review");
              ...
              return (
                <div key={s.id} className="flex items-center">
                  ...
                  {idx < stages.length - 1 && (
                    <div className={`h-px w-12 mx-2 ${isCompleted ? 'bg-green-500' : 'bg-border'}`} />
                  )}
                </div>
              );
            })}
